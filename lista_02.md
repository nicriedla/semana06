...
```
INICIO
    LER valorTotal = (Informar valor)

    SE valorTotal < 50 ENTAO
        ESCREVER "Frete não disponível!"
    SENÃO SE valorTotal >= 50 E valorTotal <= 199.99 ENTAO
...
CLASSE Veiculo
    ...
    MÉTODO CalcularConsumo()
        ESCREVER "modelo:", modelo, "ano:", ano
...
CLASSE Carro HERDA Veiculo
    ...
    MÉTODO Construtor(modelo, ano, consumoPorLitro)
        CHAMAR Construtor da classe Veiculo(modelo, ano)
        este.consumoPorLitro = consumoPorLitro

    MÉTODO CalcularConsumo(distancia)
        SE consumoPorLitro > 0 ENTAO
            consumo = distancia / consumoPorLitro
            ESCREVER "O carro consumirá ", consumo, " litros de combustível."
        SENÃO
            ESCREVER "Sem Consumo."
FIM CLASSE
...
CLASSE Moto HERDA Veiculo
    ...
    MÉTODO CalcularConsumo(distancia)
        SE consumoPorLitro > 0 ENTAO
            consumo = distancia / consumoPorLitro
            ESCREVER "A moto consumirá ", consumo, " litros de combustível."
        SENÃO
            ESCREVER "Sem consumo."
FIM CLASSE
...
INÍCIO
    ...
    SE tempo > tempoMaximo ENTÃO:
        ESCREVER("O tempo é maior que o limite permitido.")
...
Função MultiplicarMatrizesInvestimento(matrizA, matrizB):  
    ...
    linhasA = número de linhas de matrizA
    colunasB = número de colunas de matrizB
    matrizResultado = nova matriz com tamanho [linhasA, colunasB]
...
investimentosAno1 = [[500, 100], [1000, 1500]]
fatoresCrescimento = [[2000, 1000], [1400, 1100]]

resultadosInvestimentos = MultiplicarMatrizesInvestimento(investimentosAno1, fatoresCrescimento)
Escrever("Resultados dos investimentos:")
